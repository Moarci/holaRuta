...
(function () {
  ...
  const FIGURES = [
    ...
    },
    {
      ...
      text: "Bolívars genialer junger General. In der Schlacht von Ayacucho 1824 zerschlug er die letzte große spanische Armee und besiegelte damit die Unabhängigkeit ganz Südamerikas. Er wurde erster Präsident Boliviens, dessen Hauptstadt Sucre seinen Namen trägt. Mit nur 35 Jahren wurde er aus dem Hinterhalt ermordet.",
      textEn: "Bolívar's brilliant young general. At the Battle of Ayacucho in 1824 he smashed the last great Spanish army and thereby sealed the independence of all South America. He became the first president of Bolivia, whose capital Sucre bears his name. At just 35 he was assassinated in an ambush.",
      quote: "",
      quoteEn: "",
    },
    {
