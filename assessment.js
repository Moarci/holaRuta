...
(function () {
  ...
  var QUESTIONS = [
    ...
    { id: "as_cj_a1a", block: "conjugation", skill: "conjugation", level: "A1", type: "mc",
      promptDe: "Setze ein: „Yo _____ estudiante.“ (Ich bin Student.)", questionEs: "Yo _____ estudiante.",
    ...
    { id: "as_gr_a1a", block: "grammar", skill: "grammar", level: "A1", type: "mc",
      promptDe: "Welcher Artikel passt? „_____ mochila“ (der Rucksack)", questionEs: "_____ mochila",
    ...
    { id: "as_cj_a2a", block: "conjugation", skill: "conjugation", level: "A2", type: "mc",
      promptDe: "Setze ein: „Ayer _____ (comer) en un restaurante peruano.“ (yo)", questionEs: "Ayer yo _____ en un restaurante peruano.",
    ...
    { id: "as_gr_a2a", block: "grammar", skill: "grammar", level: "A2", type: "mc",
      promptDe: "ser oder estar? „El banco _____ al lado de la plaza.“ (Die Bank ist neben dem Platz.)", questionEs: "El banco _____ al lado de la plaza.",
    ...
    { id: "as_gr_a2b", block: "grammar", skill: "grammar", level: "A2", type: "mc",
      promptDe: "Welche Form passt? „A mí me _____ las arepas.“ (Ich mag Arepas.)", questionEs: "A mí me _____ las arepas.",
    ...
    { id: "as_gr_b1a", block: "grammar", skill: "grammar", level: "B1", type: "mc",
      promptDe: "Setze ein: „Espero que _____ (tú, tener) un buen viaje.“", questionEs: "Espero que _____ un buen viaje.",
    ...
    { id: "as_gr_b1b", block: "grammar", skill: "grammar", level: "B1", type: "mc",
      promptDe: "por oder para? „Este regalo es _____ ti.“ (Dieses Geschenk ist für dich.)", questionEs: "Este regalo es _____ ti.",
    ...
    { id: "as_gr_b1c", block: "grammar", skill: "grammar", level: "B1", type: "mc",
      promptDe: "Ersetze die Objekte: „¿Le diste el dinero a Juan?“ → „Sí, _____ di.“", questionEs: "Sí, _____ di.",
    ...
    { id: "as_gr_b1d", block: "grammar", skill: "grammar", level: "B1", type: "mc",
      promptDe: "Vergleich: „Bogotá es _____ grande _____ Medellín.“ (größer als)", questionEs: "Bogotá es _____ grande _____ Medellín.",
    ...
    { id: "as_gr_b2a", block: "grammar", skill: "grammar", level: "B2", type: "mc",
      promptDe: "Setze ein: „Si _____ (tener) más tiempo, viajaría por toda Sudamérica.“", questionEs: "Si _____ más tiempo, viajaría por toda Sudamérica.",
    ...
    { id: "as_gr_b2b", block: "grammar", skill: "grammar", level: "B2", type: "mc",
      promptDe: "Setze ein: „Te llamo cuando _____ (llegar) al hotel.“ (Zukunftsbezug)", questionEs: "Te llamo cuando _____ al hotel.",
    ...
    { id: "as_gr_b2c", block: "grammar", skill: "grammar", level: "B2", type: "mc",
      promptDe: "Setze ein: „Aunque _____ (estar) cansado, salí a explorar la ciudad.“ (Tatsache)", questionEs: "Aunque _____ cansado, salí a explorar la ciudad.",
    ...
    { id: "as_cj_b2a", block: "conjugation", skill: "conjugation", level: "B2", type: "mc",
      promptDe: "Setze ein: „No creo que _____ (haber) llegado todavía.“ (er/sie)", questionEs: "No creo que _____ llegado todavía.",
    ...
    { id: "as_gr_c1a", block: "grammar", skill: "grammar", level: "C1", type: "mc",
      promptDe: "Setze ein: „Si _____ (saber) la verdad antes, habría actuado distinto.“", questionEs: "Si _____ la verdad antes, habría actuado distinto.",
    ...
    { id: "as_gr_c1b", block: "grammar", skill: "grammar", level: "C1", type: "mc",
      promptDe: "Setze ein: „Habla como si lo _____ (saber) todo.“ (als ob er alles wüsste)", questionEs: "Habla como si lo _____ todo.",
    ...
    { id: "as_gr_c1c", block: "grammar", skill: "grammar", level: "C1", type: "mc",
      promptDe: "Setze ein: „No hay nadie que _____ (poder) ayudarte con eso aquí.“", questionEs: "No hay nadie que _____ ayudarte con eso aquí.",
