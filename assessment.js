...
(function () {
  ...
  var QUESTIONS = [
    ...
    { id: "as_gr_a2a", block: "grammar", skill: "grammar", level: "A2", type: "mc",
      promptDe: "ser oder estar? „La comida ▢ muy rica.“ (Das Essen ist sehr lecker.)", questionEs: "La comida ▢ muy rica.",
      options: ["es", "está", "ser", "estoy"],
      correctIndex: 1, expectedTimeSec: 12,
      explanationDe: "Geschmack/Zustand beim Probieren → estar: „está muy rica“ = schmeckt sehr gut." },
    ...
    { id: "as_fr_a2b", block: "free", skill: "free", level: "A2", type: "free",
      promptDe: "Schreib auf Spanisch: Ich heiße … (deinen Namen brauchst du nicht – nur „Ich heiße“ + irgendein Name).",
      accept: ["me llamo", "me llamo ana", "mi nombre es", "yo me llamo"], matchMode: "prefix",
      solutionEs: "Me llamo …", expectedTimeSec: 14,
      explanationDe: "„Me llamo …“ = Ich heiße … (der Anfang zählt)." },
