...
[![Tests](https://img.shields.io/badge/Tests-723_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 723 Tests in 62 Dateien (node:test, keine Dependencies)
