...
[![Tests](https://img.shields.io/badge/Tests-505_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 505 Tests in 45 Dateien (node:test, keine Dependencies)
