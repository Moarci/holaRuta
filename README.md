...
[![Tests](https://img.shields.io/badge/Tests-192_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 192 Tests in 14 Dateien (node:test, keine Dependencies)
