...
[![Tests](https://img.shields.io/badge/Tests-704_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 704 Tests in 61 Dateien (node:test, keine Dependencies)
