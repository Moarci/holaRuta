...
**v1.5.0** — 618 Karten · 21 Bereiche · Konjugieren mit Erklärseite (Conjugación) · Hostel Mode (Battle & Rollenspiele) · Definiciones (Zuordnen-Quiz) · Farben mit echtem Farbfeld · Spaced Repetition · Offline · Null Dependencies
...
[![Tests](https://img.shields.io/badge/Tests-103_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 103 Tests in 5 Dateien (node:test, keine Dependencies)
