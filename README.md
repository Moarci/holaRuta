...
[![Tests](https://img.shields.io/badge/Tests-727_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 727 Tests in 64 Dateien (node:test, keine Dependencies)
