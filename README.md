...
[![Tests](https://img.shields.io/badge/Tests-535_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 535 Tests in 49 Dateien (node:test, keine Dependencies)
