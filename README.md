...
[![Tests](https://img.shields.io/badge/Tests-606_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 606 Tests in 54 Dateien (node:test, keine Dependencies)
