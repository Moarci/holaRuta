...
├── icon.svg                     # App-Icon
│
├── test/                        # 154 Tests in 11 Dateien (node:test, keine Dependencies)
