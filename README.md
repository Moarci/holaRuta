...
[![Tests](https://img.shields.io/badge/Tests-33_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/sc.test.js              # 33 Tests (node:test, keine Dependencies)
