...
[![Tests](https://img.shields.io/badge/Tests-616_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 616 Tests in 55 Dateien (node:test, keine Dependencies)
