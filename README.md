...
[![Tests](https://img.shields.io/badge/Tests-301_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 301 Tests in 27 Dateien (node:test, keine Dependencies)
