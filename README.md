...
[![Tests](https://img.shields.io/badge/Tests-774_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 774 Tests in 69 Dateien (node:test, keine Dependencies)
