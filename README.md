...
[![Tests](https://img.shields.io/badge/Tests-492_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 492 Tests in 42 Dateien (node:test, keine Dependencies)
