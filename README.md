...
[![Tests](https://img.shields.io/badge/Tests-414_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 414 Tests in 34 Dateien (node:test, keine Dependencies)
