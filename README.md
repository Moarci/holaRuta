...
[![Tests](https://img.shields.io/badge/Tests-41_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
|---|---:|---|---:|---|---:|
| Zahlen | 110 | Essen | 60 | Compras (Einkaufen) | 34 |
| Sätze | 30 | Verkehr | 27 | Hotel | 24 |
...
├── icon.svg                     # App-Icon
│
├── test/sc.test.js              # 41 Tests (node:test, keine Dependencies)
...
| `spanischcard.gamestats.v1` | Ruta-Pass: Spiel-Zähler (Streak, Tageszeit-Marken, „Nochmal“, Hostel-Mode-Battles & -Rollenspiele) + freigeschaltete Badges |
...
**Gruppen:** Lernreise (Lernmenge), Dranbleiben (Streak), Bereiche (je Kategorie ein Stempel — inkl. **Hostel** & **Social**), **Hostel Mode** (Battle & Rollenspiele) und Spezial (inkl. **Geheim-Stempel**, die erst nach Freischaltung sichtbar werden).

Der **Hostel Mode** zahlt direkt auf den Pass ein: ein beendetes Battle schaltet *First Duel* frei, ein klarer Sieg *Dorm Champion*, eine fehlerfreie Partie *Perfect Check-in*; gespielte Rollenspiele füllen *First Scene* und *Scene Collector*. Gezählt wird in denselben `gamestats` (battlesPlayed/-Won/perfect, distinkte Rollenspiele).
