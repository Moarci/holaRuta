...
[![Tests](https://img.shields.io/badge/Tests-734_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 734 Tests in 63 Dateien (node:test, keine Dependencies)
