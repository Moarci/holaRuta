...
[![Tests](https://img.shields.io/badge/Tests-215_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 215 Tests in 18 Dateien (node:test, keine Dependencies)
