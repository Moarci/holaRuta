...
[![Tests](https://img.shields.io/badge/Tests-424_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 424 Tests in 34 Dateien (node:test, keine Dependencies)
