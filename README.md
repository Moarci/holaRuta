...
[![Tests](https://img.shields.io/badge/Tests-676_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 642 Tests in 59 Dateien (node:test, keine Dependencies)
