...
[![Tests](https://img.shields.io/badge/Tests-469_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 469 Tests in 37 Dateien (node:test, keine Dependencies)
