...
[![Tests](https://img.shields.io/badge/Tests-693_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 693 Tests in 60 Dateien (node:test, keine Dependencies)
