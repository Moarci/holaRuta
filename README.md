...
[![Tests](https://img.shields.io/badge/Tests-709_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 709 Tests in 61 Dateien (node:test, keine Dependencies)
