...
[![Tests](https://img.shields.io/badge/Tests-735_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 735 Tests in 63 Dateien (node:test, keine Dependencies)
