...
[![Tests](https://img.shields.io/badge/Tests-546_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 546 Tests in 50 Dateien (node:test, keine Dependencies)
