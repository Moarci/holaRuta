...
[![Tests](https://img.shields.io/badge/Tests-302_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 302 Tests in 27 Dateien (node:test, keine Dependencies)
