...
[![Tests](https://img.shields.io/badge/Tests-758_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 758 Tests in 66 Dateien (node:test, keine Dependencies)
