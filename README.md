...
[![Tests](https://img.shields.io/badge/Tests-310_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 310 Tests in 28 Dateien (node:test, keine Dependencies)
