...
[![Tests](https://img.shields.io/badge/Tests-277_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 277 Tests in 24 Dateien (node:test, keine Dependencies)
