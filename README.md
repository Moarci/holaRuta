...
[![Tests](https://img.shields.io/badge/Tests-473_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 473 Tests in 38 Dateien (node:test, keine Dependencies)
