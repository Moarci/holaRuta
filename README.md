...
[![Tests](https://img.shields.io/badge/Tests-500_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 500 Tests in 44 Dateien (node:test, keine Dependencies)
