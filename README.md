...
[![Tests](https://img.shields.io/badge/Tests-340_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 340 Tests in 30 Dateien (node:test, keine Dependencies)
