...
[![Tests](https://img.shields.io/badge/Tests-724_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 722 Tests in 63 Dateien (node:test, keine Dependencies)
