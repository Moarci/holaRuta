...
[![Tests](https://img.shields.io/badge/Tests-543_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 543 Tests in 50 Dateien (node:test, keine Dependencies)
