...
[![Tests](https://img.shields.io/badge/Tests-283_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 283 Tests in 25 Dateien (node:test, keine Dependencies)
