...
[![Tests](https://img.shields.io/badge/Tests-708_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 708 Tests in 61 Dateien (node:test, keine Dependencies)
