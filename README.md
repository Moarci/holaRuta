...
[![Tests](https://img.shields.io/badge/Tests-799_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 799 Tests in 71 Dateien (node:test, keine Dependencies)
