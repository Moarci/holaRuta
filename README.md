...
[![Tests](https://img.shields.io/badge/Tests-511_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 511 Tests in 46 Dateien (node:test, keine Dependencies)
