...
[![Tests](https://img.shields.io/badge/Tests-189_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 189 Tests in 14 Dateien (node:test, keine Dependencies)
