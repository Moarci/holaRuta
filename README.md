...
[![Tests](https://img.shields.io/badge/Tests-339_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 339 Tests in 30 Dateien (node:test, keine Dependencies)
