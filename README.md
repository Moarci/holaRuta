...
[![Tests](https://img.shields.io/badge/Tests-485_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 485 Tests in 37 Dateien (node:test, keine Dependencies)
