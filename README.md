...
[![Tests](https://img.shields.io/badge/Tests-307_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 307 Tests in 28 Dateien (node:test, keine Dependencies)
