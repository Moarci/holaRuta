...
[![Tests](https://img.shields.io/badge/Tests-309_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 309 Tests in 28 Dateien (node:test, keine Dependencies)
