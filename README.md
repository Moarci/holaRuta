...
[![Tests](https://img.shields.io/badge/Tests-487_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 487 Tests in 41 Dateien (node:test, keine Dependencies)
