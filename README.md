...
[![Tests](https://img.shields.io/badge/Tests-471_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 471 Tests in 36 Dateien (node:test, keine Dependencies)
