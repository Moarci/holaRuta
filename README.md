...
[![Tests](https://img.shields.io/badge/Tests-516_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 516 Tests in 47 Dateien (node:test, keine Dependencies)
