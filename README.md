...
[![Tests](https://img.shields.io/badge/Tests-595_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 595 Tests in 54 Dateien (node:test, keine Dependencies)
