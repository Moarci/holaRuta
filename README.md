...
[![Tests](https://img.shields.io/badge/Tests-712_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 712 Tests in 61 Dateien (node:test, keine Dependencies)
