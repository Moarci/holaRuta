...
[![Tests](https://img.shields.io/badge/Tests-730_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 730 Tests in 63 Dateien (node:test, keine Dependencies)
