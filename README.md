...
[![Tests](https://img.shields.io/badge/Tests-504_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 504 Tests in 38 Dateien (node:test, keine Dependencies)
