...
[![Tests](https://img.shields.io/badge/Tests-578_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 578 Tests in 51 Dateien (node:test, keine Dependencies)
