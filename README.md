...
[![Tests](https://img.shields.io/badge/Tests-327_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 327 Tests in 29 Dateien (node:test, keine Dependencies)
