...
[![Tests](https://img.shields.io/badge/Tests-359_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 359 Tests in 33 Dateien (node:test, keine Dependencies)
