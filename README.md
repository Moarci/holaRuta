...
[![Tests](https://img.shields.io/badge/Tests-702_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 702 Tests in 61 Dateien (node:test, keine Dependencies)
