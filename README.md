...
[![Tests](https://img.shields.io/badge/Tests-390_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 390 Tests in 34 Dateien (node:test, keine Dependencies)
