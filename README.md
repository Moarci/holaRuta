...
[![Tests](https://img.shields.io/badge/Tests-521_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 521 Tests in 48 Dateien (node:test, keine Dependencies)
