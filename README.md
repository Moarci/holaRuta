...
[![Tests](https://img.shields.io/badge/Tests-496_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 496 Tests in 43 Dateien (node:test, keine Dependencies)
