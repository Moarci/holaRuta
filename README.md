...
[![Tests](https://img.shields.io/badge/Tests-690_passing-brightgreen?style=flat-square&logo=nodedotjs&logoColor=white)](#-tests)
...
├── icon.svg                     # App-Icon
│
├── test/                        # 690 Tests in 60 Dateien (node:test, keine Dependencies)
