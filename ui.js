...
(function () {
  ...
  function entdeckenBody(vm) {
    ...
    const has = { countries: vm.hasCountries, historia: vm.hasHistoria, historiaCentro: vm.hasHistoriaCentro, speech: vm.hasSpeech, frases: vm.hasFrases, dialogos: vm.hasDialogos, knigge: vm.hasKnigge, regatear: vm.hasRegatear, logistica: vm.hasLogistica, salud: vm.hasSalud, fotos: vm.hasFotos, bailar: vm.hasBailar, placement: vm.hasPlacement, assessment: vm.hasAssessment };
    const featBtn = (x) => `
  ...
  window.SC.ui = { esc, renderHome, renderSearch, searchResults, renderOnboarding, renderStudy, renderDone, renderStats, renderCard, renderEditor, renderInfo, renderHistoria, renderKnigge, renderBebidas, renderRegatear, renderLogistica, renderSalud, renderFotos, renderBailar, renderTeacher, renderTask, renderPlacement, renderAssessment, renderPrintSheet,
