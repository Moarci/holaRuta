...
(function () {
  ...
  const FEATURES = [
    ...
    { action: "open-quiz-setup", tracks: ["de-es", "es-en", "de-en"],  icon: "lc:puzzle", titleKey: "discover.definicionesName",  subKey: "discover.subDefiniciones", sub: "Definition lesen, Begriff wählen",       grad: ["#3F7355", "#2F6B70"], group: "play" },
    ...
    { action: "open-knigge",      tracks: ["de-es", "de-en"], icon: "lc:compass", titleKey: "discover.kniggeName", subKey: "discover.subKnigge", sub: "Verhalten unterwegs: Hostel, Bus, Gruppen", grad: ["#3F6B8E", "#6B4FA8"], need: "knigge", group: "reference" },
    { action: "open-logistica",   tracks: ["de-es", "de-en"], icon: "lc:luggage", titleKey: "discover.logisticaName", subKey: "discover.subLogistica", sub: "SIM, Geld & Gepäck – clever & sicher ankommen", grad: ["#2F6B70", "#B97C24"], need: "logistica", group: "reference" },
    { action: "open-salud",       tracks: ["de-es", "de-en"], icon: "lc:salad", titleKey: "discover.saludName",   subKey: "discover.subSalud", sub: "Gesund & fit bleiben: Essen, Trinken, Bewegung", grad: ["#2F8E5B", "#76954E"], need: "salud", group: "reference" },
    ...
    { action: "open-derechos",    tracks: ["de-es", "de-en"], icon: "lc:scale", titleKey: "discover.derechosName", subKey: "discover.subDerechos", sub: "Ruhig & sicher bleiben: Kontrolle, Anwalt, Botschaft", grad: ["#3F5BA8", "#5A4FA8"], need: "derechos", group: "reference" },
    { action: "open-responsable", tracks: ["de-es", "de-en"], icon: "lc:sprout", titleKey: "discover.responsableName",  subKey: "discover.subResponsable", sub: "Leichter Fußabdruck: kein Müll, lokal kaufen, kein Plastik", grad: ["#3F7355", "#5E7D3A"], need: "responsable", group: "reference" },
    { action: "open-fotos",       tracks: ["de-es", "de-en"], icon: "lc:camera", titleKey: "discover.fotosName",    subKey: "discover.subFotos", sub: "Tolle Reisebilder: Motiv, Licht, Posen & Teilen", grad: ["#C25A45", "#5A4FA8"], need: "fotos", group: "reference" },
