...
(function () {
  ...
  const THEMES = [
    {
      id: "comida", icon: "lc:utensils", label: "Comida", labelEn: "Food", labelDe: "Essen",
      items: [
    ...
    {
      id: "bebidas", icon: "lc:cup-soda", label: "Bebidas", labelEn: "Drinks", labelDe: "Getränke",
      items: [
    ...
    {
      id: "animales", icon: "lc:paw-print", label: "Animales", labelEn: "Animals", labelDe: "Tiere",
      items: [
    ...
    {
      id: "viaje", icon: "lc:luggage", label: "De viaje", labelEn: "Travel gear", labelDe: "Reisegepäck",
      items: [
    ...
    {
      id: "naturaleza", icon: "lc:palmtree", label: "Naturaleza", labelEn: "Nature", labelDe: "Natur",
      items: [
    ...
    {
      id: "casa", icon: "lc:house", label: "En casa", labelEn: "At home", labelDe: "Zuhause",
      items: [
  ...
  function themeList() {
    return THEMES.map((t) => ({ id: t.id, icon: t.icon, label: t.label, labelEn: t.labelEn, labelDe: t.labelDe, count: t.items.length }));
  }
