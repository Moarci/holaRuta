...
test("Content: Locals-Kategorien sind 7 Gruppen mit spanischem labelEs", () => {
  const groups = new Set(dataLocals.CATEGORIES.map((c) => c.group));
  assert.deepEqual([...groups].sort(), ["loc-b2", "loc-cult", "loc-dia", "loc-esc", "loc-hosp", "loc-trab", "loc-voc"]);
