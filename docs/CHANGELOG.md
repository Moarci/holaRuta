...
**“Ruta-Check” becomes “HolaRuta-Check” + dashboard reminder**
...
**Onboarding: Name & Geschlecht zuerst, Ruta-Check nachholbar**
...
**Onboarding: name & gender first, Ruta-Check can be done later**
...
**Modo profe: Bundles – ein Link, mehrere Aufgaben**
...
**Teacher mode: bundles – one link, several tasks**
...
**Modo profe: Ziel-Auswahl als erklärtes Modal statt Dropdown**
...
**Teacher mode: target selection as an explained modal, not a dropdown**
...
**Erscheinungsbild im Stil deines Reiselands**
...
**Appearance in the style of your travel country**
...
**Trip-Ziel & Erscheinungsbild klarer bedienbar**
...
**Trip goal & appearance: clearer to use**
...
**Bebidas AM/PM: Tag- und Abendgetränk pro Land**
...
**Bebidas AM/PM: morning and evening drink per country**
...
**„Dein Fortschritt“: echte Lern-Verteilung statt leerem Balken**
...
**“Your progress”: real learning split instead of an empty bar**
...
**Neuer „Start“-Reiter: Dashboard aufgeräumt, Themen mit Sprungmarken**
...
**New “Home” tab: tidier dashboard, topics with quick-jumps**
...
**Conjugación: Erklärseite jetzt auch auf Englisch**
...
**Conjugación: explanation page now in English too**
...
**Tiempos: Schnellsprung-Navigation & Feinschliff**
...
**Tiempos: quick-jump navigation & polish**
...
**Tiempos: Vergangenheits-Trick mit dem Gerundium**
...
**Tiempos: past-tense trick with the gerund**
...
**Tiempos: der einfache Vergangenheits-Trick**
...
**Tiempos: the simple past-tense trick**
...
**Diálogos: Hintergrund zu „Besser so“**
...
**Diálogos: background on “Better like this”**
...
**Drei neue Themenblöcke: Friseur & Beauty, Sport & Fitness, Arbeiten & Freiwilligenarbeit**
...
**Three new topic blocks: Hairdresser & Beauty, Sport & Fitness, Work & Volunteering**
...
**Vier neue Themenblöcke: Geldautomat & Bank, Post & Versand, Kinder & Familie, Vegetarisch & Allergien**
...
**Four new topic blocks: ATM & Bank, Post & Shipping, Kids & Family, Vegetarian & Allergies**
...
**Vier neue Themenblöcke: Strand & Wassersport, Nachtleben, Wetter, Mietwagen**
...
**Four new topic blocks: Beach & Water Sports, Nightlife, Weather, Rental Car**
...
**Vier neue Themenblöcke: Apotheke & Arzt, Touren & Outdoor, SIM & Internet, Wäsche & Services**
...
**Four new topic blocks: Pharmacy & Doctor, Tours & Outdoor, SIM & Internet, Laundry & Services**
...
**Vier neue Stadt-Packs: Torres del Paine, Pucón, Copacabana & Sucre**
...
**Four new city packs: Torres del Paine, Pucón, Copacabana & Sucre**
...
**Fünf neue Stadt-Packs: Santiago, Valparaíso, Atacama, La Paz & Uyuni**
...
**Five new city packs: Santiago, Valparaíso, Atacama, La Paz & Uyuni**
...
**Acht neue Stadt-Packs: Lima, Arequipa, Mendoza, Bariloche, Oaxaca, Mérida, La Fortuna & Monteverde**
...
**Eight new city packs: Lima, Arequipa, Mendoza, Bariloche, Oaxaca, Mérida, La Fortuna & Monteverde**
...
**Vier neue Stadt-Packs: CDMX, Antigua, Buenos Aires, Quito**
...
**Four new city packs: CDMX, Antigua, Buenos Aires, Quito**
...
**Aktivitätsblatt: Review-Feinschliff**
...
**Druckbares Aktivitätsblatt für Lehrkraft & Reiseleitung 📄**
...
**Printable activity sheet for teachers & tour leaders 📄**
...
**Cartagena-Pack: Review-Feinschliff & Dashboard-Kachel**
...
**Cartagena pack: review polish & dashboard tile**
...
**Politur: Paste-Hinweis & Barrierearmut**
...
**Polish: paste note & accessibility**
...
**Angefangene Aufgaben heben sich ab**
...
**Aufgaben-Fortschritt sichtbar + Feinschliff (Review-Block)**
...
**Task progress visible + polish (review block)**
...
**Pre-Arrival-Kachel zeigt „geschafft“**
...
**Absolvierte Aufgaben werden als erledigt markiert**
...
**Editions-Footer: sauberer Text-Credit statt Platzhalter-Logo**
...
**Edition footer: clean text credit instead of placeholder logo**
...
**Aufgaben-Code einfügen funktioniert jetzt überall**
...
**Pasting a task code now works everywhere**
...
**Editions-Credit aufgeräumt (Logo + „mit HolaRuta“)**
...
**Edition credit cleaned up (logo + “with HolaRuta”)**
...
**Länderkunde: Bevölkerung, Politik & Wirtschaft**
...
**Country facts: population, politics & economy**
...
**Geteilte Modul-Links öffnen direkt das Modul**
...
**Shared module links open the module directly**
...
**„Modul teilen“ jetzt in allen Entdecken-Modulen**
...
**“Share module” now in all Discover modules**
...
**Historia de Centroamérica: die zweite große Geschichte**
...
**Historia de Centroamérica: the second great history**
...
**Klarere Onboarding-Überschrift**
...
**Abnahme-Politur: Onboarding, Aufgaben-Robustheit & klarere Texte**
...
**Acceptance polish: onboarding, task robustness & clearer texts**
...
**Mehrere Aufgaben parallel – per Link teilbar & abonnierbar**
...
**Several tasks in parallel – shareable & subscribable via link**
...
**Gebrandeter Einstiegslink: direkt ins Onboarding, mit Partner-Logo**
...
**Branded entry link: straight into onboarding, with partner logo**
...
**Ruta-Check: fairere Einstufung + Qualitäts-Hinweis**
...
**Ruta-Check: fairer placement + quality note**
...
**Modo profe wandert in den Tarea-Reiter (Editionen) + Ruta-Check-Feinschliff**
...
**Modo profe moves into the Tarea tab (editions) + Ruta-Check polish**
...
**Ruta-Check wird adaptiv – und Teil des Onboardings**
...
**Ruta-Check becomes adaptive – and part of onboarding**
...
**Ruta-Check: kurzer, reisepraktischer Einstufungstest**
...
**Ruta-Check: short, travel-practical placement test**
...
**Zugewiesenes Reiseziel ist fix + Kopieren/Einfügen funktioniert mobil**
...
**Assigned destination is fixed + copy/paste works on mobile**
...
**Editionen: Modo profe & Tarea als eigene Reiter, raus aus Entdecken**
...
**Editions: Modo profe & Tarea as their own tabs, out of Discover**
...
**Aufgaben erstellen: Auswahl bleibt stehen + klares Kopieren/Einfügen**
...
**Creating tasks: selection stays + clear copy/paste**
...
**Nach der Etappe zurück zum Plan – und ein eigener „Tarea“-Reiter**
...
**After the stage, back to the plan – and a dedicated “Tarea” tab**
...
**Optionale Cloud-Sync – Fundament für Schul-/Partner-Editionen**
...
**Optional cloud sync – foundation for school/partner editions**
...
**Aufgaben teilen: Zuweisung per Code – ganz ohne Konto**
...
**Share tasks: assignment via code – completely without an account**
...
**Modo profe: Klassenübersicht für Lehrkräfte & Reiseleiter**
...
**Modo profe: class overview for teachers & tour leaders**
...
**Drei neue Reise-Pakete: Argentinien, Chile & Bolivien**
...
**Three new travel packs: Argentina, Chile & Bolivia**
...
**Zwei neue Reise-Pakete: Ecuador & Guatemala**
...
**Two new travel packs: Ecuador & Guatemala**
...
**Pre-Trip-Plan jetzt für vier Reiseziele**
...
**Pre-Trip plan now for four destinations**
...
**Zwei neue Reise-Pakete: Mexiko & Costa Rica**
...
**Two new travel packs: Mexico & Costa Rica**
...
**Pre-Arrival Peru: die wichtigsten Sätze auf einen Tap**
...
**Pre-Arrival Peru: the most important phrases in one tap**
...
**Neues Reise-Paket: Peru (Cusco, Machu Picchu & Anden)**
...
**New travel pack: Peru (Cusco, Machu Picchu & the Andes)**
...
**Kolumbien-Paket: Kaffeeregion ergänzt (Salento & Valle del Cocora)**
...
**Colombia pack: coffee region added (Salento & Valle del Cocora)**
...
**Bessere Lesbarkeit im Dunkelmodus**
...
**Pre-Trip-Plan: in 7 Etappen reisefertig**
...
**Pre-Trip plan: travel-ready in 7 stages**
...
**Coordinator-Schnellstart: 5-Minuten-Icebreaker**
...
**Coordinator quick start: 5-minute icebreaker**
...
**Mehr Real-Life Challenges: 30 statt 10**
...
**More Real-Life Challenges: 30 instead of 10**
...
**Pre-Arrival-Preset: die wichtigsten Sätze auf einen Tap**
...
**Pre-Arrival preset: the most important phrases in one tap**
...
**Kolumbien-Paket: 75 ortsspezifische Reise-Karten**
...
**Colombia pack: 75 location-specific travel cards**
...
**Historia-Modul als Ganzes teilen**
...
**Share the Historia module as a whole**
...
**Historia de Sudamérica: die große Geschichte**
...
**Historia de Sudamérica: the big story**
...
**Salud y energía: gesund & fit unterwegs**
...
**Salud y energía: healthy & fit on the road**
...
**Logística de viaje: clever & sicher ankommen**
...
**Logística de viaje: arrive smart & safe**
...
**Trip-Ziel: gleich zu Beginn gesetzt, im Profil verwaltet**
...
**Trip goal: set right at the start, managed in the profile**
...
**Aufgeräumte Einstellungen & automatische Updates**
...
**Tidied-up settings & automatic updates**
...
**Zurück-Wischen führt zurück, statt die App zu schließen**
...
**Swiping back goes back, instead of closing the app**
...
**Wochentage: je ein Tag, eine Karte**
...
**Days of the week: one day, one card each**
...
**Diálogos: längere Gespräche & runderer Ablauf**
...
**Diálogos: longer conversations & a smoother flow**
...
**Diálogos, Conjugador, Sprechtempo & Trip-Ziel**
...
**Diálogos, Conjugador, speaking speed & trip goal**
...
**Sharepics: App-Link zum Mitlernen**
...
**Sharepics: app link to learn along**
...
**Ruta-Pass: Stempel als Sharepic teilen**
...
**Ruta-Pass: share stamps as a sharepic**
...
**Spickzettel: bessere Auswahl, Großanzeige & Sprungleiste**
...
**Cheat sheet: better selection, large display & jump bar**
...
**Einkaufszettel: echtes Abhaken + Fragen fürs Geschäft**
...
**Shopping list: real check-off + questions for the shop**
...
**Regatear: negotiate & haggle well**
...
**Karten überspringen: nicht jede Karte muss durch**
...
**Skip cards: not every card has to be done**
...
**Gegenteile: Antonym-Paare lernen**
...
**Precios al oído: deutlich mehr & größere Preise**
...
**Precios al oído: many more & larger prices**
...
**Reise-Knigge: Toilettenpapier-Regel**
...
**Travel etiquette: the toilet-paper rule**
...
**Travel etiquette: how to behave on the road**
...
**Einkaufszettel: interaktiv für Supermarkt, Kleidung & Farmacia**
...
**Shopping list: interactive for supermarket, clothing & farmacia**
...
**Zeiten: neuer Bereich + große Erklärseite**
...
**Tenses: new section + big explainer page**
...
**Frases flexibles: Themen & viel mehr Sätze**
...
**Frases flexibles: topics & many more sentences**
...
**Konjugieren: neuer Bereich + Erklärseite**
...
**Conjugating: new section + explainer page**
...
**Hören, Spickzettel, Precios, Satzbaukasten & Ruta del día**
...
**Listening, cheat sheet, Precios, sentence builder & Ruta del día**
...
**Battle: fairer, mehr Inhalt, Stichrunde**
...
**Battle: fairer, more content, tiebreaker round**
