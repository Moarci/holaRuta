# HolaRuta — Zielkunden & Kontakt-Fahrplan
...
> Stand der Einschätzung: Juni 2026.

---

## Stufe A — Erst hier (höchste Passung, Kolumbien/Cartagena)
...
## Stufe B — Danach (LatAm-Immersion, skalierbar)

| Prio | Ziel | Typ | Warum | Kontaktweg |
|---|---|---|---|---|
| 4 | **Maximo Nivel** | Schulnetz (Costa Rica/Guatemala/Peru) | Mehrere Standorte, junge internationale Zielgruppe – bester Skalierungskandidat | Website / Partnerships |
| 5 | **Linguaschools** | Boutique-Netzwerk (ES + LatAm) | Erwachsene, offen für Zusatztools | Website / Zentrale |
| 6 | **Kleine LatAm-/Backpacker-Gruppenreise-Anbieter** | Gruppenreisen | Schneller Pilot als große Ketten; Coordinator-Schnellstart passt | direkt / über persönliche Reise-Kontakte |

---

## Stufe C — Später (groß, lange Sales-Zyklen — erst mit Referenz)
