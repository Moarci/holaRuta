...
(function () {
  ...
  reg("home", {
    ...
    analyticsOn: "Sí",
    analyticsOff: "No",
    analyticsHint: "Seudónimo, sin nombres ni contenidos de tus propias tarjetas. Activado por defecto.",
  ...
  reg("discover", {
    ...
    subMedCiudad: "La ciudad: Comuna 13, Metro, medio ambiente y seguridad — con las frases.",
    subMedPaisa: "Cultura, comida, fiestas y Guatapé en inglés — con las frases.",
    medTips: "Consejos",
    medPhrases: "Frases clave",
    medWords: "Glosario paisa",
  ...
  reg("profile", {
    ...
    settings: "Ajustes",
    myTrip: "Mi viaje",
    showDetails: "Detalles e historial",
    yourData: "Tus datos",
    exportData: "Exportar datos",
    importData: "Importar datos",
    migrationBannerText: "HolaRuta se muda: desde ahora nos encuentras en holaruta.com. Exporta tu copia e impórtala allí para conservar tu progreso.",
    migrationBannerBtn: "Exportar copia",
    migrationBannerUrl: "Abrir holaruta.com",
  ...
  reg("teacher", {
    ...
    composerHeading: "Crear tareas y paquetes",
    composerHint: "En el estudio de tareas armas paquetes de aprendizaje en tres pasos y los compartes como enlace, código QR o mensaje de WhatsApp: un toque suscribe las tareas a tu grupo.",
    composerBtn: "Abrir estudio de tareas",
  ...
  // ---------- composer: Estudio de tareas (crear tareas y paquetes) ----------
  reg("composer", {
    title: "Tareas y paquetes",
    step1: "Contenido",
    step2: "Detalles",
    step3: "Compartir",
    stepOf: function (p) { return "Paso " + p.n + " de 3"; },
    guideBtn: "Guía",
    close: "Cerrar",
    introStep1: "Elige lo que tu grupo debe aprender. Todo se combina libremente y se puede quitar de nuevo.",
    catalogLabel: "Catálogo de contenido",
    tabVorlagen: "Plantillas",
    tabPretrip: "Planes de viaje",
    tabCurso: "Rutas de aprendizaje",
    tabPreset: "Kits de inicio",
    tabCategory: "Temas",
    helpVorlagen: "Paquetes listos para situaciones típicas: el camino más rápido. Un toque selecciona todo el contenido incluido.",
    helpPretrip: "Planes de viaje de varios días, por etapas: ideal para prepararse paso a paso para un viaje concreto.",
    helpCurso: "Cursos por etapas, parte por parte. Ideal para que tu grupo construya su inglés paso a paso, de lo básico a lo avanzado.",
    helpPreset: "Kits de inicio compactos: lo esencial en un paquete para una preparación rápida y enfocada.",
    helpCategory: "Temas completos (p. ej. comida, números, emergencias). Ideal para practicar un tema a fondo.",
    searchPh: "Buscar, p. ej. «comida» …",
    searchNone: "Nada encontrado. Busca un tema (p. ej. «comida») o vacía el campo para ver el catálogo.",
    metaCards: function (p) { return p.n + " tarjetas"; },
    metaStages: function (p) { return p.n + " etapas · " + p.cards + " tarjetas"; },
    bundleMeta: function (p) { return p.n + " objetivos · " + p.cards + " tarjetas"; },
    selEmpty: "Aún no hay nada elegido: toca el contenido para añadirlo.",
    selCount: function (p) { return p.n === 1 ? "1 objetivo" : p.n + " objetivos"; },
    selSummary: function (p) { return "Total: " + p.n + (p.n === 1 ? " objetivo" : " objetivos") + " · " + p.cards + " tarjetas"; },
    clear: "Vaciar",
    next: "Siguiente",
    ...
    bgKurs: "📚 Curso y plan de estudios",
    bgSituation: "🎒 Situaciones cotidianas",
    bgOrga: "🆘 Seguridad y organización",
    introStep2: "Revisa tu paquete y, si quieres, ponle un título y una fecha límite. Los estudiantes ven ambos en su lista de tareas.",
    summaryHeading: "Tu paquete",
    addMore: "Elegir más contenido",
    remove: "Quitar",
    titleLabel: "Título (opcional)",
    titlePh: "p. ej. «Semana 1» o «Tarea para el viernes»",
    titleHint: "Aparece sobre la tarea; un título claro ayuda cuando hay varias tareas.",
    dueLabel: "Fecha límite (opcional)",
    dueHint: "Solo como orientación: la fecha se muestra con la tarea y esta sigue abierta después.",
    backStep: "Atrás",
    toShare: "Crear enlace y QR",
    readyHeading: "Listo para compartir",
    singleKind: "Tarea individual",
    bundleKind: function (p) { return "Paquete con " + p.n + " tareas"; },
    dueShort: function (p) { return "límite " + p.date; },
    qrAria: "Código QR para suscribir la tarea",
    qrHint: "Muestra el código QR y deja que lo escaneen: con el proyector, en la reunión o desde tu teléfono.",
    copyLink: "Copiar enlace",
    copied: "¡Copiado!",
    whatsapp: "Compartir por WhatsApp",
    shareSystem: "Compartir …",
    shareMsg: function (p) { return "«" + p.title + "»: toca el enlace y la tarea queda suscrita en HolaRuta:"; },
    codeDetails: "Código para pegar (alternativa)",
    codeHint: "Si el enlace no llega: copia el código y los estudiantes lo pegan en la app, en «Tarea».",
    copyCode: "Copiar código",
    howHeading: "Así llega la tarea",
    how1: "Compartes el enlace, el código QR o el mensaje de WhatsApp con tu grupo.",
    how2: "Un toque (o un escaneo) abre HolaRuta y suscribe todas las tareas incluidas automáticamente, sin cuenta ni registro.",
    how3: "Las tareas aparecen en «Tarea», corren en paralelo y muestran allí su progreso.",
    newTask: "Crear otro paquete",
    guideTitle: "Guía: tareas y paquetes",
    gLead: "Para docentes y coordinadores: aquí armas paquetes de aprendizaje y los repartes con un enlace, sin cuentas ni servidor, apto para trabajar sin conexión.",
    gWhatH: "¿Qué es una tarea?",
    gWhat: "Una tarea es un objetivo de aprendizaje (una ruta o un tema) que repartes como enlace o código. Si eliges varios objetivos, se crea un paquete: un solo enlace crea varias tareas a la vez.",
    gStepsH: "Cómo proceder (3 pasos)",
    gSteps: "1. Elegir contenido: toca una plantilla o arma tu propia combinación del catálogo. 2. Detalles: título y fecha límite (opcional). 3. Compartir: copia el enlace, muestra el QR o envíalo por WhatsApp.",
    gTeachH: "Consejos para la clase",
    gTeach: "Usa títulos claros y fechas límite para las tareas semanales. Importa tu clase en la vista de la clase: los estudiantes exportan su copia de seguridad en el perfil y tú ves progreso y niveles.",
    gGuideH: "Consejos para coordinadores",
