...
(function () {
  ...
  const CATEGORY_BADGES = [
    ...
    { category: "hotel",   icon: "🛏️", name: "Dorm Diplomat",       nameEn: "Dorm Diplomat",        description: "Meistere 80 % der Hotel-Karten.", descriptionEn: "Master 80% of the hotel cards." },
    { category: "hostel",  icon: "🔑", name: "Check-in Champion",    nameEn: "Check-in Champion",    description: "Meistere 80 % der Hostel-Karten.", descriptionEn: "Master 80% of the hostel cards." },
