...
(function () {
  ...
  const DANCES = [
    ...
    },
    {
      ...
      originEn: "Cuba",
      level: "B1",
      compas: "4/4 – zwei Schritte, dann drei schnelle: „cha-cha-chá“ auf 3-und-4.",
      compasEn: "4/4 – two steps, then three quick ones: „cha-cha-chá“ on 3-and-4.",
      count: "1 · 2 · 3 · & · 4 · 5 · 6 · 7 · & · 8",
      ...
      steps: [
        { beat: "1", foot: "L", x: 76, y: 86, rot: -4 },
        { beat: "2", foot: "R", x: 124, y: 150, rot: 5 },
        { beat: "3", foot: "L", x: 70, y: 150, rot: -5 },
        { beat: "&", foot: "R", x: 102, y: 146, rot: 4 },
        { beat: "4", foot: "L", x: 86, y: 166, rot: -3 },
        { beat: "5", foot: "R", x: 124, y: 214, rot: 6 },
        { beat: "6", foot: "L", x: 76, y: 150, rot: -4 },
        { beat: "7", foot: "R", x: 128, y: 150, rot: 5 },
        { beat: "&", foot: "L", x: 98, y: 150, rot: -3 },
        { beat: "8", foot: "R", x: 112, y: 166, rot: 3 },
      ],
      dos: [
        "Das „cha-cha-chá“ klein und schnell halten: drei winzige Schrittchen auf 3-&-4.",
      ...
      dosEn: [
        "Keep the „cha-cha-chá“ small and quick: three tiny steps on 3-&-4.",
      ...
      es: [
        ...
        "Esos tres pasos van en „tres-y-cuatro“ y son muy *pequeños*. Cuenta despacio „uno, dos, cha-cha-chá“ y después sigue la música.",
    ...
    },
    {
      ...
      count: "lento · lento · lento · lento · lento · la cruz",
      intro: "Eleganz und Spannung. Tango ist im Kern das „caminar“ – ruhiges, geerdetes Gehen im Paar, Brust an Brust. Aus den Gehschritten wächst die berühmte „cruz“ – der typische Kreuzschritt, bei dem die Füße übereinandergesetzt werden. Langsam, präzise, mit Pausen.",
      introEn: "Elegance and tension. At its core, tango is „caminar“ – calm, grounded walking as a couple, chest to chest. From the walking steps grows the famous „cruz“ – the signature cross step where the feet cross over. Slow, precise, with pauses.",
      steps: [
    ...
    },
    {
      ...
      count: "1 · 2 · 3 · 4 (al ritmo del dembow)",
