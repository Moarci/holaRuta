...
(function () {
  ...
  const GENRES = [
    {
      ...
      vocab: [
        { es: "el ritmo", de: "der Rhythmus", en: "the rhythm", take: true },
        { es: "alegre", de: "fröhlich", en: "cheerful", take: true },
        { es: "la fiesta", de: "die Feier / Party", en: "the party", take: true },
    ...
    },
    {
      ...
      q: "salsa",
      es: [
        "La *salsa* mezcla el son cubano con el jazz de Nueva York. Tiene muchos *instrumentos de viento* y un ritmo rápido que llena las *pistas de baile*.",
        "Si no sabes bailar, no te preocupes: pide que alguien te *enseñe* unos pasos básicos y déjate llevar.",
      ],
      vocab: [
        { es: "los instrumentos de viento", de: "die Blasinstrumente", en: "wind/brass instruments", take: true },
        { es: "la pista de baile", de: "die Tanzfläche", en: "the dance floor", take: true },
        { es: "enseñar", de: "beibringen / zeigen", en: "to teach", take: true },
        { es: "los pasos", de: "die (Tanz-)Schritte", en: "the steps", take: true },
      ],
      level: "A2",
    },
    {
      ...
      vocab: [
        { es: "la canción", de: "das Lied", en: "the song", take: true },
        { es: "la discoteca", de: "der Club / die Disco", en: "the club", take: true },
        { es: "los jóvenes", de: "die jungen Leute", en: "young people", take: true },
        { es: "la jerga", de: "der Slang", en: "the slang", take: true },
      ],
      level: "A2",
    },
    {
      ...
      vocab: [
        { es: "melancólico", de: "melancholisch / wehmütig", en: "melancholic", take: true },
        { es: "la pareja", de: "das Paar", en: "the couple / partner", take: true },
        { es: "el espectáculo", de: "die Show / das Schauspiel", en: "the show", take: true },
        { es: "el barrio", de: "das Stadtviertel", en: "the neighbourhood", take: true },
      ],
      level: "B1",
    },
    {
      ...
      artists: ["Vicente Fernández", "Lila Downs", "Natalia Lafourcade", "Javier Solís"],
      q: "mariachi ranchera",
      es: [
      ...
      vocab: [
        { es: "el corazón", de: "das Herz", en: "the heart", take: true },
        { es: "la tierra", de: "die Heimat / das Land", en: "the homeland / land", take: true },
        { es: "el cumpleaños", de: "der Geburtstag", en: "the birthday", take: true },
        { es: "la serenata", de: "das Ständchen", en: "the serenade", take: true },
      ],
      level: "B1",
    },
    {
      ...
      vocab: [
        { es: "el acordeón", de: "das Akkordeon", en: "the accordion", take: true },
        { es: "la historia", de: "die Geschichte", en: "the story", take: true },
        { es: "el pueblo", de: "das Dorf / die Kleinstadt", en: "the town/village", take: true },
        { es: "contar", de: "erzählen", en: "to tell", take: true },
      ],
      level: "B1",
    },
    {
      ...
      q: "bachata merengue",
      es: [
        "El *merengue* es rápido y muy alegre; la *bachata* es más lenta y *romántica*, perfecta para bailar en pareja bien juntos.",
      ...
      vocab: [
        ...
        { es: "el amor", de: "die Liebe", en: "love", take: true },
        { es: "lento", de: "langsam", en: "slow", take: true },
    ...
    },
    {
      ...
      vocab: [
        { es: "la letra", de: "der (Lied-)Text", en: "the lyrics", take: true },
        { es: "la gente", de: "die Leute", en: "the people", take: true },
        { es: "la montaña", de: "der Berg", en: "the mountain", take: true },
        { es: "el campo", de: "das Land / die Landschaft", en: "the countryside", take: true },
      ],
      level: "B1",
    },
    {
      ...
      es: [
        ...
        "Busca a artistas como Shakira o Soda Stereo, escucha una *canción* favorita varias veces e intenta cantar el *estribillo*.",
      ],
      vocab: [
        { es: "el estribillo", de: "der Refrain", en: "the chorus", take: true },
        { es: "la letra", de: "der (Lied-)Text", en: "the lyrics", take: true },
        { es: "aprender", de: "lernen", en: "to learn", take: true },
        { es: "favorito", de: "Lieblings-", en: "favourite", take: true },
      ],
      level: "A2",
    },
  ];
  ...
  const COUNTRY = {
    mexico:      { genre: "Mariachi & Ranchera", genreEn: "Mariachi & ranchera", artist: "Vicente Fernández", song: "Cielito Lindo", q: "mariachi vicente fernandez" },
