...
(function () {
  ...
  i18n.register("social", {
    ...
    shareCode: "Teilen",
    shareTitle: "Mein HolaRuta-Freundescode",
    shareMsg: (p) => `Füge mich bei HolaRuta hinzu! Mein Freundes-Code: ${p.code}`,
    ...
    shareCode: "Share",
    shareTitle: "My HolaRuta friend code",
    shareMsg: (p) => `Add me on HolaRuta! My friend code: ${p.code}`,
