...
(function () {
  ...
  i18n.register("home", {
    ...
    analyticsCap: "Anonyme Nutzungsstatistik teilen",
    analyticsAria: "Anonyme Nutzungsstatistik teilen an oder aus",
    analyticsOn: "An",
    analyticsOff: "Aus",
    analyticsHint: "Hilft uns zu sehen, wie viele die App nutzen und welche Modi. Anonym, kein Konto, keine Karteninhalte – nur grobe Zahlen. Standardmäßig aus.",
    uiLanguage: "Sprache",
    ...
    analyticsCap: "Share anonymous usage stats",
    analyticsAria: "Share anonymous usage stats on or off",
    analyticsOn: "On",
    analyticsOff: "Off",
    analyticsHint: "Helps us see how many people use the app and which modes. Anonymous, no account, no card content – just rough numbers. Off by default.",
    uiLanguage: "Language",
    homePrompt: "¿Qué aprendemos hoy?",
    homePromptName: (p) => `¿Qué aprendemos hoy, ${p.name}?`,
