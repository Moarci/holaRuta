...
(function () {
  ...
  i18n.register("teacher", {
    ...
    taskShareHint: "Schick den Link per WhatsApp/Mail – ein Tipp abonniert die Aufgabe. Mehrere Aufgaben gehen parallel. (Der Code funktioniert weiterhin zum Einfügen.)",
    ...
    taskShareHint: "Send the link via WhatsApp/email – one tap subscribes the task. Multiple tasks run in parallel. (The code still works for pasting.)",
  ...
  i18n.register("task", {
    ...
    paste: "Einfügen",
    pasted: "Eingefügt.",
    pasteFail: "Zwischenablage nicht lesbar – bitte den Code von Hand einfügen.",
    ...
    empty: "Noch keine Aufgaben. Füge eine per Code oder Link hinzu.",
    added: "Aufgabe hinzugefügt.",
    already: "Diese Aufgabe hattest du schon – nach oben geholt.",
  }, {
    title: "Tarea",
    ...
    paste: "Paste",
    pasted: "Pasted.",
    pasteFail: "Couldn't read the clipboard – please paste the code manually.",
    ...
    empty: "No tasks yet. Add one via code or link.",
    added: "Task added.",
    already: "You already had this task – moved to top.",
  });
