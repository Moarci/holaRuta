...
(function () {
  ...
  i18n.register("discover", {
    ...
    subCarrito: "Selling English for kids at the cart: offer, prices & role-play",
    ...
    subAssessment: "In-depth (A0–C1) or Extremo with listening",
    ...
    cursoSub: "Step by step, ready for English",
  ...
  i18n.register("assessment", {
    ...
    startExtremo: (p) => `Start Extremo · ${p.n} questions`,
    ...
    variant_standard: "Standard",
    variant_extremo: "Extremo",
    extremoNoAudio: "🔇 The Extremo test (with listening) needs your browser's speech output – it isn't available here right now.",
    start: "Start test",
    qOf: (p) => `Question ${p.i} of ${p.n}`,
    optionsLabel: "Answer choices",
    answer: "Check answer",
