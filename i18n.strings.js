...
(function () {
  ...
  i18n.register("profile", {
    ...
    masteryHint: (p) => `Gemeistert = ab ${p.days} Tagen Wiederholungs-Abstand (≈ 3× richtig an verschiedenen Tagen). Vorher zählt es als „fast geschafft“.`,
    routeNew: "Neu",
    ...
    masteryHint: (p) => `Mastered = a review gap of ${p.days}+ days (≈ 3 correct on different days). Before that it counts as "almost there".`,
    routeNew: "New",
