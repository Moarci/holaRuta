...
(function () {
  ...
  i18n.register("home", {
    ...
    presetCtgTitle: "Pre-Arrival Cartagena",
    ...
    presetCusTitle: "Pre-Arrival Cusco",
    presetCusSub: "Stadt-Sätze vor der Ankunft: Höhe, Machu Picchu, Heiliges Tal",
    presetCdmxTitle: "Pre-Arrival Mexiko-Stadt",
    ...
    presetQuiTitle: "Pre-Arrival Quito",
    ...
    presetArequipaTitle: "Pre-Arrival Arequipa",
    ...
    presetBarilocheTitle: "Pre-Arrival Bariloche",
    ...
    presetSantiagoTitle: "Pre-Arrival Santiago",
    ...
    presetAtacamaTitle: "Pre-Arrival San Pedro de Atacama",
    ...
    presetPuertonatalesTitle: "Pre-Arrival Torres del Paine",
    ...
    // HelloAbroad (Track de-en): eigene Slides 1/3/4 statt der Reise-Spanisch-Texte
    // oben – Slide 2 (Lernmodi) ist track-neutral und bleibt geteilt (siehe ui.js
    ...
    onboardNameInvalid: "Bitte gib deinen Namen ein.",
    ...
    analyticsCap: "Nutzungsstatistik teilen",
    ...
    catGroupLocVoc: "Vocabulary by topic",
    catGroupLocB2: "B2 vocabulary (advanced)",
    ...
    presetCdmxTitle: "Pre-Arrival Mexico City",
    ...
    // HelloAbroad (de-en track) EN pendants — required for DE⟷EN key parity
    // (this UI-language layer is never actually shown for de-en, whose
    ...
    onboardNameInvalid: "Please enter your name.",
    ...
    analyticsCap: "Share usage stats",
    analyticsAria: "Share usage stats on or off",
    analyticsOn: "On",
    analyticsOff: "Off",
    analyticsHint: "Helps us improve the app: which features get used, where things snag, plus error reports. Pseudonymous, no account, no content/names/search terms – just coarse events. Off by default.",
  ...
  i18n.register("study", {
    ...
    context: "🧭 Kontext",
    // Work-Varianten (Locals-Track es-en, Englisch lernen) – ohne Reise-Wortlaut.
    contextTitleWork: "🧭 So nutzt du es bei der Arbeit",
    contextNoteWork: "Tipp",
    contextShowWork: "Kontext anzeigen",
    contextHideWork: "🧭 Kontext ausblenden",
    contextWork: "🧭 Kontext",
    ...
    context: "🧭 Context",
    // Work variants (locals track es-en, learning English) – no travel wording.
    contextTitleWork: "🧭 How to use it at work",
    contextNoteWork: "Tip",
    contextShowWork: "Show context",
    contextHideWork: "🧭 Hide context",
    contextWork: "🧭 Context",
  ...
  i18n.register("discover", {
    ...
    // Entdecken-Ratgeber & Tests, im de-en-Track adoptiert: Basiszeile = die spanische
    // Marke (unverändert im Reise-Track de-es sichtbar), …DeEn = deutsche HelloAbroad-
    // Benennung. Speist Kachel-Titel (ui.js FEATURES titleKey), Screen-Kopf (cfg.title)
    // und Sharepic-Titel (app.js MODULE_SHARE/TIPS_META titleKey) synchron.
    kniggeName: "Etiqueta de viaje",
    kniggeNameDeEn: "Reise-Knigge",
    logisticaName: "Logística de viaje",
    logisticaNameDeEn: "Reise-Logistik",
    saludName: "Salud y energía",
    saludNameDeEn: "Gesund unterwegs",
    fotosName: "Fotos y videos",
    fotosNameDeEn: "Fotos & Videos",
    responsableName: "Viaja responsable",
    responsableNameDeEn: "Nachhaltig reisen",
    derechosName: "Conoce tus derechos",
    derechosNameDeEn: "Deine Rechte",
    juegosName: "Juegos de viaje",
    juegosNameDeEn: "Reisespiele",
    definicionesName: "Definiciones",
    definicionesNameDeEn: "Quiz",
    placementName: "HolaRuta-Check",
    placementNameDeEn: "Einstufungs-Check",
    assessmentName: "Nivel-Test",
    assessmentNameDeEn: "Niveau-Test",
    ...
    subAssessmentDeEn: "Ausführlicher Sprachtest (A0–C1): dein genaues Englisch-Niveau",
    ...
    subCursoEs: "Der Spanisch-Kurs: 4 Wochen, Woche für Woche",
    cursoTitle: "Lernpfad",
    cursoSub: "Schritt für Schritt fit fürs Englisch",
    cursoIntro: "Bau dein Englisch Schritt für Schritt auf: ein Teil nach dem anderen – der nächste öffnet sich, sobald du den aktuellen geschafft hast.",
    cursoDestLabel: "Kurs wählen",
    ...
    // Banderas – Flaggen-Quiz, Galería & Saber más
    bndSetupIntro: "Lern die Flaggen Lateinamerikas und Spaniens spielerisch: Erst raten, dann erfährst du bei jeder Antwort, wofür Farben und Symbole stehen.",
    bndPlayHead: "🎮 Quiz: Flagge erraten",
    bndLearnHead: "📚 Lernen & nachschlagen",
    bnd_sur: "Sudamérica",
    bnd_sur_icon: "🌎",
    bnd_sur_desc: "Südamerika – von Argentinien bis Venezuela",
    ...
    bndGaleriaDesc: "Alle Flaggen durchblättern: Farben, Symbolik & Merk-Fakt",
    bndGaleriaIntro: "Tipp auf ein Land, um Farben, Bedeutung und eine Eselsbrücke zu sehen.",
    bndSaberMas: "Saber más sobre banderas",
    bndSaberMasDesc: "Wissen zu Flaggen insgesamt: Farben, Symbole & Etikette",
    bndQuestion: "¿De qué país es esta bandera?",
    bndCount: (p) => `Flagge ${p.pos}/${p.total}`,
    ...
    bnWords: "🗣️ Wörter rund um Flaggen",
    bnChecklist: "🧠 Flaggen sicher merken",
    bnChecklistHint: "Ein paar Tricks, mit denen jede Flagge hängen bleibt.",
    ...
    kniggeName: "Etiqueta de viaje",
    kniggeNameDeEn: "Travel etiquette",
    logisticaName: "Logística de viaje",
    logisticaNameDeEn: "Travel logistics",
    saludName: "Salud y energía",
    saludNameDeEn: "Stay healthy",
    fotosName: "Fotos y videos",
    fotosNameDeEn: "Photos & videos",
    responsableName: "Viaja responsable",
    responsableNameDeEn: "Travel responsibly",
    derechosName: "Conoce tus derechos",
    derechosNameDeEn: "Your rights",
    juegosName: "Juegos de viaje",
    juegosNameDeEn: "Travel games",
    definicionesName: "Definiciones",
    definicionesNameDeEn: "Quiz",
    placementName: "HolaRuta-Check",
    placementNameDeEn: "Placement check",
    assessmentName: "Nivel-Test",
    assessmentNameDeEn: "Level test",
    subAssessmentDeEn: "In-depth level test (A0–C1): your exact English level",
    ...
    subCursoEs: "The Spanish course: 4 weeks, week by week",
    cursoTitle: "Learning path",
    cursoSub: "Job-ready, week by week",
    cursoIntro: "Build your English step by step: one part at a time – the next unlocks once you finish the current one.",
    cursoDestLabel: "Choose course",
    ...
    // Banderas – flag quiz, gallery & learn more
    bndSetupIntro: "Learn the flags of Latin America and Spain the playful way: guess first, then every answer reveals what the colours and symbols mean.",
    bndPlayHead: "🎮 Quiz: guess the flag",
    bndLearnHead: "📚 Learn & look up",
    bnd_sur: "Sudamérica",
    bnd_sur_icon: "🌎",
    bnd_sur_desc: "South America – from Argentina to Venezuela",
    bnd_centro: "Centroamérica y el Caribe",
    bnd_centro_icon: "🌴",
    ...
    bndGaleria: "Galería de banderas",
    bndGaleriaDesc: "Browse every flag: colours, symbolism & a memory hook",
    bndGaleriaIntro: "Tap a country to see its colours, meaning and a memory hook.",
    bndSaberMas: "Saber más sobre banderas",
    bndSaberMasDesc: "Flag knowledge overall: colours, symbols & etiquette",
    bndQuestion: "¿De qué país es esta bandera?",
    bndCount: (p) => `Flag ${p.pos}/${p.total}`,
    bndRegSur: "🌎 Sudamérica",
    bndRegCentro: "🌴 México, Centroamérica y el Caribe",
    bndRegEuropa: "🇪🇺 Europe",
    bndRegMundo: "🌍 El mundo",
    ...
    bnWords: "🗣️ Words around flags",
    bnChecklist: "🧠 Memorise flags for good",
  ...
  i18n.register("teacher", {
    ...
    colLevelDeEn: "Einstufungs-Check (Level · Score)",
    colPacks: "Gemeisterte Pakete (≥80 %)",
    reviewed: (p) => `${p.n} gelernt`,
    remove: "Entfernen",
    defaultName: "Schüler",
    composerHeading: "Aufgaben & Pakete erstellen",
    composerHint: "Stell im Aufgaben-Studio in drei Schritten Lernpakete zusammen und teile sie als Link, QR-Code oder WhatsApp-Nachricht – ein Antippen abonniert die Aufgaben bei deiner Gruppe.",
    composerBtn: "Aufgaben-Studio öffnen",
    ...
    grpCursoHelp: "Englischkurs in Etappen, Teil für Teil. Nimm das, wenn deine Gruppe ihr Englisch Schritt für Schritt aufbauen soll – ein roter Faden von den Grundlagen bis zu den fortgeschrittenen Teilen.",
    ...
    colPretrip: "Pre-trip",
    colLevel: "HolaRuta-Check (level · score)",
    colLevelDeEn: "Placement check (level · score)",
    colPacks: "Mastered packs (≥80%)",
    reviewed: (p) => `${p.n} reviewed`,
    remove: "Remove",
    defaultName: "Student",
    composerHeading: "Create tasks & packs",
    composerHint: "Use the task studio to build learning packs in three steps and share them as a link, QR code or WhatsApp message – one tap subscribes the tasks for your group.",
    composerBtn: "Open task studio",
    grpPretrip: "Pre-trip plans",
    grpCurso: "Learning paths",
    ...
    grpCursoHelp: "A staged English course in parts. Use this when your group should build up their English step by step – a common thread from the basics to the advanced parts.",
  ...
  // ---------- composer: Aufgaben-Studio (Aufgaben & Pakete erstellen) ----------
  // Der geführte 3-Schritte-Ablauf für Lehrkräfte & Reiseleitung (features/composer.js):
  // Inhalte wählen → Details → Teilen (Link/QR/WhatsApp), plus eingebaute Anleitung.
  i18n.register("composer", {
    title: "Aufgaben & Pakete",
    step1: "Inhalte",
    step2: "Details",
    step3: "Teilen",
    stepOf: (p) => `Schritt ${p.n} von 3`,
    guideBtn: "Anleitung",
    close: "Schließen",
    // Schritt 1 – Inhalte wählen
    introStep1: "Wähle aus, was deine Gruppe lernen soll. Vorlagen sind fertige Pakete zum Antippen – alles lässt sich frei kombinieren und wieder abwählen.",
    catalogLabel: "Inhalts-Katalog",
    tabVorlagen: "Vorlagen",
    tabPretrip: "Reisepläne",
    tabCurso: "Lernpfade",
    tabPreset: "Starter-Sets",
    tabCategory: "Themen",
    helpVorlagen: "Fertig geschnürte Pakete für typische Situationen – der schnellste Weg. Antippen wählt alle enthaltenen Inhalte; du kannst danach einzelne Ziele entfernen oder ergänzen.",
    helpPretrip: "Mehrtägige Reise-Fahrpläne in Etappen. Ideal, wenn sich deine Gruppe Schritt für Schritt auf eine konkrete Reise vorbereiten soll – von der Ankunft bis zum letzten Tag.",
    helpCurso: "Kurse in Etappen, Teil für Teil. Ideal, wenn deine Gruppe ihr Englisch Schritt für Schritt aufbauen soll – von den Grundlagen bis zu den fortgeschrittenen Teilen.",
    helpPreset: "Kompakte Starter-Sets fürs Reiseziel: das Wichtigste gebündelt für eine schnelle, fokussierte Vorbereitung kurz vor der Ankunft.",
    helpCategory: "Komplette Themenbereiche (z. B. Essen, Zahlen, Notfall). Ideal, um ein Thema gezielt und in der Tiefe zu üben – unabhängig vom Reiseziel.",
    searchPh: "Suchen, z. B. „Essen“ oder „Kolumbien“ …",
    searchNone: "Nichts gefunden. Such nach einem Thema (z. B. „Essen“) oder einem Reiseziel – oder leere das Suchfeld für den Katalog.",
    metaCards: (p) => `${p.n} Karten`,
    metaStages: (p) => `${p.n} Etappen · ${p.cards} Karten`,
    bundleMeta: (p) => `${p.n} Ziele · ${p.cards} Karten`,
    selEmpty: "Noch nichts gewählt – tippe Inhalte an.",
    selCount: (p) => (p.n === 1 ? "1 Ziel" : `${p.n} Ziele`),
    selSummary: (p) => `Zusammen: ${p.n} ${p.n === 1 ? "Ziel" : "Ziele"} · ${p.cards} Karten`,
    clear: "Leeren",
    next: "Weiter",
    needItems: "Wähle zuerst mindestens einen Inhalt aus.",
    genFailed: "Konnte den Code nicht erzeugen – bitte erneut versuchen.",
    tooMany: (p) => `Maximal ${p.n} Ziele pro Paket.`,
    customBundle: "Eigenes Paket",
    bgDestino: "🌎 Reiseziel-Komplett",
    bgKurs: "📚 Kurs & Lehrplan",
    bgSituation: "🎒 Alltags-Situationen",
    bgOrga: "🆘 Sicherheit & Orga",
    // Schritt 2 – Details
    introStep2: "Prüfe dein Paket und gib ihm – wenn du magst – einen Titel und eine Frist. Beides sehen die Lernenden in ihrer Aufgabenliste.",
    summaryHeading: "Dein Paket",
    addMore: "Weitere Inhalte wählen",
    remove: "Entfernen",
    titleLabel: "Titel (optional)",
    titlePh: "z. B. „Woche 1: Ankommen“ oder „Hausaufgabe bis Freitag“",
    titleHint: "Erscheint bei den Lernenden über der Aufgabe – ein sprechender Titel hilft bei mehreren Aufgaben.",
    dueLabel: "Frist (optional)",
    dueHint: "Reine Orientierung: Die Frist wird bei der Aufgabe angezeigt, nach Ablauf bleibt sie trotzdem offen.",
    backStep: "Zurück",
    toShare: "Link & QR erzeugen",
    // Schritt 3 – Teilen
    readyHeading: "Bereit zum Teilen",
    singleKind: "Einzelaufgabe",
    bundleKind: (p) => `Paket mit ${p.n} Aufgaben`,
    dueShort: (p) => `Frist ${p.date}`,
    qrAria: "QR-Code zum Abonnieren der Aufgabe",
    qrHint: "QR-Code zeigen und scannen lassen – z. B. über den Beamer, im Vortreffen oder direkt vom Handy.",
    copyLink: "Link kopieren",
    copied: "Kopiert!",
    whatsapp: "Per WhatsApp teilen",
    shareSystem: "Teilen …",
    shareMsg: (p) => `„${p.title}“ – tippe den Link an, dann ist die Aufgabe in HolaRuta abonniert:`,
    codeDetails: "Code zum Einfügen (Notlösung)",
    codeHint: "Falls der Link nicht ankommt: Code kopieren – die Lernenden fügen ihn in der App unter „Tarea“ ein.",
    copyCode: "Code kopieren",
    howHeading: "So kommt die Aufgabe an",
    how1: "Du teilst den Link, den QR-Code oder die WhatsApp-Nachricht mit deiner Gruppe.",
    how2: "Ein Antippen (oder Scannen) öffnet HolaRuta und abonniert alle enthaltenen Aufgaben automatisch – ohne Konto, ohne Anmeldung.",
    how3: "Die Aufgaben erscheinen bei den Lernenden unter „Tarea“, laufen parallel und zeigen dort ihren Fortschritt.",
    newTask: "Neues Paket erstellen",
    // Anleitung (Overlay)
    guideTitle: "Anleitung: Aufgaben & Pakete",
    gLead: "Für Lehrkräfte und Reiseleitung: Hier stellst du Lernpakete zusammen und verteilst sie mit einem Link – ohne Konten, ohne Server, komplett offline-tauglich.",
    gWhatH: "Was ist eine Aufgabe?",
    gWhat: "Eine Aufgabe ist ein Lernziel (ein Reiseplan, ein Starter-Set oder ein Thema), das du als Link oder Code verteilst. Wählst du mehrere Ziele, entsteht ein Paket: ein einziger Link legt bei den Lernenden mehrere Aufgaben auf einmal an.",
    gStepsH: "So gehst du vor (3 Schritte)",
    gSteps: "1. Inhalte wählen: Vorlage antippen oder eigene Kombination aus dem Katalog bauen. 2. Details: Titel und Frist vergeben (optional). 3. Teilen: Link kopieren, QR-Code zeigen oder direkt per WhatsApp senden.",
    gTeachH: "Tipps für den Unterricht",
    gTeach: "Die Lehrplan-Vorlagen (Woche 1–3, Grammatik) eignen sich als Wochen-Hausaufgaben – mit sprechendem Titel und Frist. Deine Klasse importierst du über die Klassenübersicht: Schüler:innen exportieren ihr Backup im Profil, du liest die Dateien ein und siehst Fortschritt und Niveau-Verteilung.",
    gGuideH: "Tipps für die Reiseleitung",
    ...
    step2: "Details",
    step3: "Share",
    stepOf: (p) => `Step ${p.n} of 3`,
    guideBtn: "Guide",
    close: "Close",
    introStep1: "Choose what your group should learn. Templates are ready-made packs you add with one tap – everything combines freely and can be deselected again.",
    catalogLabel: "Content catalogue",
    tabVorlagen: "Templates",
    tabPretrip: "Trip plans",
    tabCurso: "Learning paths",
    tabPreset: "Starter sets",
    tabCategory: "Topics",
    helpVorlagen: "Ready-made packs for typical situations – the fastest route. Tapping selects all included content; you can remove or add individual targets afterwards.",
    helpPretrip: "Multi-day travel plans in stages. Ideal when your group should prepare step by step for a specific trip – from arrival to the final day.",
    helpCurso: "Staged courses, part by part. Ideal when your group should build up their English step by step – from the basics to the advanced parts.",
    helpPreset: "Compact starter sets for the destination: the essentials bundled for quick, focused prep shortly before arrival.",
    helpCategory: "Whole topic areas (e.g. food, numbers, emergencies). Ideal for practising one topic thoroughly – independent of the destination.",
    searchPh: "Search, e.g. “food” or “Colombia” …",
    searchNone: "Nothing found. Search for a topic (e.g. “food”) or a destination – or clear the search box to browse the catalogue.",
    metaCards: (p) => `${p.n} cards`,
    metaStages: (p) => `${p.n} stages · ${p.cards} cards`,
    bundleMeta: (p) => `${p.n} targets · ${p.cards} cards`,
    selEmpty: "Nothing selected yet – tap content to add it.",
    selCount: (p) => (p.n === 1 ? "1 target" : `${p.n} targets`),
    selSummary: (p) => `Total: ${p.n} ${p.n === 1 ? "target" : "targets"} · ${p.cards} cards`,
    clear: "Clear",
    next: "Next",
    needItems: "Choose at least one piece of content first.",
    genFailed: "Couldn't create the code – please try again.",
    tooMany: (p) => `At most ${p.n} targets per pack.`,
    customBundle: "Custom pack",
    bgDestino: "🌎 Destination complete",
    bgKurs: "📚 Course & syllabus",
    bgSituation: "🎒 Everyday situations",
    bgOrga: "🆘 Safety & admin",
    introStep2: "Review your pack and – if you like – give it a title and a due date. Learners see both in their task list.",
    summaryHeading: "Your pack",
    addMore: "Choose more content",
    remove: "Remove",
    titleLabel: "Title (optional)",
    titlePh: "e.g. “Week 1: Arriving” or “Homework by Friday”",
    titleHint: "Shown to learners above the task – a descriptive title helps when several tasks run at once.",
    dueLabel: "Due date (optional)",
    dueHint: "For orientation only: the date is shown with the task, and the task stays open after it passes.",
    backStep: "Back",
    toShare: "Create link & QR",
    readyHeading: "Ready to share",
    singleKind: "Single task",
    bundleKind: (p) => `Pack with ${p.n} tasks`,
    dueShort: (p) => `due ${p.date}`,
    qrAria: "QR code to subscribe to the task",
    qrHint: "Show the QR code and let everyone scan it – via projector, at the pre-trip meeting or straight from your phone.",
    copyLink: "Copy link",
    copied: "Copied!",
    whatsapp: "Share via WhatsApp",
    shareSystem: "Share …",
    shareMsg: (p) => `“${p.title}” – tap the link and the task is subscribed in HolaRuta:`,
    codeDetails: "Code for manual pasting (fallback)",
    codeHint: "If the link doesn't arrive: copy the code – learners paste it in the app under “Tarea”.",
    copyCode: "Copy code",
    howHeading: "How the task arrives",
    how1: "You share the link, the QR code or the WhatsApp message with your group.",
    how2: "One tap (or scan) opens HolaRuta and subscribes all included tasks automatically – no account, no sign-up.",
    how3: "The tasks appear for learners under “Tarea”, run in parallel and show their progress there.",
    newTask: "Create another pack",
    guideTitle: "Guide: tasks & packs",
    gLead: "For teachers and tour leaders: build learning packs here and hand them out with one link – no accounts, no server, fully offline-friendly.",
    gWhatH: "What is a task?",
    gWhat: "A task is a learning target (a trip plan, a starter set or a topic) that you distribute as a link or code. Pick several targets and you get a pack: a single link creates several tasks at once for your learners.",
    gStepsH: "How to proceed (3 steps)",
    gSteps: "1. Choose content: tap a template or build your own combination from the catalogue. 2. Details: add a title and due date (optional). 3. Share: copy the link, show the QR code or send it via WhatsApp.",
    gTeachH: "Tips for the classroom",
    gTeach: "The syllabus templates (weeks 1–3, grammar) work well as weekly homework – with a descriptive title and a due date. Import your class via the class overview: students export their backup in their profile, you read the files in and see progress and level distribution.",
    gGuideH: "Tips for tour leaders",
  ...
  i18n.register("profile", {
    ...
    myTrip: "Meine Reise",
    showDetails: "Details & Verlauf",
    yourData: "Deine Daten",
    exportData: "Daten exportieren",
    importData: "Daten importieren",
    migrationBannerText: "HolaRuta zieht um: Ab jetzt findest du uns unter holaruta.com. Sichere dein Backup und importiere es dort, damit dein Fortschritt mitkommt.",
    migrationBannerBtn: "Backup exportieren",
    migrationBannerUrl: "holaruta.com öffnen",
    ...
    settings: "Settings",
    myTrip: "My trip",
    showDetails: "Details & history",
    yourData: "Your data",
    exportData: "Export data",
    importData: "Import data",
    migrationBannerText: "HolaRuta is moving: from now on you'll find us at holaruta.com. Back up your data and import it there so your progress comes along.",
    migrationBannerBtn: "Export backup",
    migrationBannerUrl: "Open holaruta.com",
    cloudSync: "Cloud sync",
  ...
  i18n.register("share", {
    ...
    myPlacementDeEn: "🎯 MY PLACEMENT CHECK",
    myPlacementName: (p) => `🎯 ${String(p.name).toUpperCase()}'S HOLARUTA-CHECK`,
    myPlacementNameDeEn: (p) => `🎯 ${String(p.name).toUpperCase()}'S PLACEMENT CHECK`,
    plLevelCap: "My starting level",
    plScore: (p) => `Score ${p.score}%`,
    plTempo: "Pace",
    captionPlacementHead: (p) => `🎯 My travel-Spanish starting level: ${p.level}`,
    captionPlacementHeadDeEn: (p) => `🎯 My travel-English starting level: ${p.level}`,
    captionPlacement: "Placed with the HolaRuta-Check – your travel Spanish for real situations. 🌎",
    captionPlacementDeEn: "Placed with the placement check – your travel English for real situations. 🌎",
    myAssessment: "📋 MY LEVEL TEST",
    myAssessmentDeEn: "📋 MY LEVEL TEST",
    myAssessmentName: (p) => `📋 ${String(p.name).toUpperCase()}'S LEVEL TEST`,
    myAssessmentNameDeEn: (p) => `📋 ${String(p.name).toUpperCase()}'S LEVEL TEST`,
    asLevelCap: "My level",
    captionAssessmentHead: (p) => `📋 My Spanish level: ${p.level}`,
    captionAssessmentHeadDeEn: (p) => `📋 My English level: ${p.level}`,
    captionAssessment: "Precisely placed with the HolaRuta Level Test (A0–C1). 🌎",
    captionAssessmentDeEn: "Precisely placed with the level test (A0–C1). 🌎",
  ...
  i18n.register("social", {
    ...
    // Einladung per QR/Link – ersetzt das Hin-und-Her-Kopieren des HRF1-Codes.
    inviteCap: "Deine Einladung",
    inviteHint: "Scannen lassen – oder den Link verschicken.",
    qrAlt: "QR-Code mit deiner HolaRuta-Einladung",
    shareInvite: "Einladung teilen",
    copyLink: "Link kopieren",
    linkCopied: "Link kopiert.",
    manualCode: "Stattdessen Code eingeben",
    inviteConfirm: "Einladung annehmen? Ihr taucht dann gemeinsam in der Tages-Rangliste auf.",
    inviteLoginNeeded: "Melde dich an, um die Einladung anzunehmen.",
    inviteBad: "Diese Einladung ist ungültig oder abgelaufen.",
    inviteSelf: "Das ist deine eigene Einladung. 🙂",
    shareInviteMsg: (p) => `Lern mit mir bei HolaRuta! Öffne diesen Link, dann seht ihr euch in der Tages-Rangliste: ${p.url}`,
    ...
    yourRank: (p) => `Dein Platz: ${p.n}`,
    shareTitle: "Meine HolaRuta-Einladung",
    ...
    inviteCap: "Your invite",
    inviteHint: "Let them scan it – or send the link.",
    qrAlt: "QR code with your HolaRuta invite",
    shareInvite: "Share invite",
    copyLink: "Copy link",
    linkCopied: "Link copied.",
    manualCode: "Enter a code instead",
    inviteConfirm: "Accept this invite? You'll both show up in the daily ranking.",
    inviteLoginNeeded: "Sign in to accept the invite.",
    inviteBad: "This invite is invalid or expired.",
    inviteSelf: "That's your own invite. 🙂",
    shareInviteMsg: (p) => `Learn with me on HolaRuta! Open this link and we'll see each other in the daily ranking: ${p.url}`,
    ...
    retry: "Try again",
    yourRank: (p) => `Your rank: ${p.n}`,
    shareTitle: "My HolaRuta invite",
  ...
  i18n.register("favorites", {
    ...
    otherGroup: "Weitere",
    errDup: "Den Eintrag gibt es schon in deinem Lexikon.",
    filterPlaceholder: "Lexikon durchsuchen …",
    filterClear: "Suche leeren",
    filterNone: (p) => `Kein Treffer für „${p.q}“.`,
    edit: "Eintrag bearbeiten",
    saveBtn: "Speichern",
    cancelBtn: "Abbrechen",
    updated: "Eintrag aktualisiert. ✏️",
    removed: "Aus dem Lexikon entfernt.",
    undo: "Rückgängig",
    addCat: "Bereich (optional)",
    ...
    otherGroup: "More",
    errDup: "That entry is already in your lexicon.",
    filterPlaceholder: "Search your lexicon …",
    filterClear: "Clear search",
    filterNone: (p) => `No match for “${p.q}”.`,
    edit: "Edit entry",
    saveBtn: "Save",
    cancelBtn: "Cancel",
    updated: "Entry updated. ✏️",
    removed: "Removed from your lexicon.",
    undo: "Undo",
    addCat: "Area (optional)",
