...
(function () {
  ...
  i18n.register("home", {
    ...
    placementOpenTitle: "🎯 Ruta-Check noch offen",
    ...
    onboardSkip: "Skip",
    placementOpenTitle: "🎯 Ruta-Check still open",
  ...
  i18n.register("share", {
    ...
    myPlacement: "🎯 MEIN RUTA-CHECK",
    myPlacementName: (p) => `🎯 RUTA-CHECK VON ${String(p.name).toUpperCase()}`,
    plLevelCap: "Mein Startlevel",
    plScore: (p) => `Score ${p.score}%`,
    plTempo: "Tempo",
    captionPlacementHead: (p) => `🎯 Mein Startlevel im Reise-Spanisch: ${p.level}`,
    captionPlacement: "Eingestuft mit dem Ruta-Check von HolaRuta – dein Reise-Spanisch für echte Situationen. 🌎",
  }, {
    sideNative: "ENGLISH",
    ...
    myPlacement: "🎯 MY RUTA-CHECK",
    myPlacementName: (p) => `🎯 ${String(p.name).toUpperCase()}'S RUTA-CHECK`,
    plLevelCap: "My starting level",
    plScore: (p) => `Score ${p.score}%`,
    plTempo: "Pace",
    captionPlacementHead: (p) => `🎯 My travel-Spanish starting level: ${p.level}`,
    captionPlacement: "Placed with HolaRuta's Ruta-Check – your travel Spanish for real situations. 🌎",
  });
})();
