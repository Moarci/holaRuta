...
(function () {
  ...
  const PHRASES = [
    {
      ...
      items: [
        ...
        { es: "¿Puede conseguirme un traductor, por favor?", de: "Kann ich bitte einen Dolmetscher bekommen?", en: "Can I have an interpreter, please?" },
  ...
  const GLOSSARY = [
    ...
    { es: "la migración", de: "die Einwanderungsbehörde", en: "immigration" },
