...
(function () {
  ...
  var CARDS = [
    ...
    { id: "loc-mes05", cat: "meseros", lvl: 2, es: "¿Cómo desea la carne?", en: "How would you like your steak?", tip: "jau wud yu laik yor stéik" },
    ...
    { id: "loc-mes10", cat: "meseros", lvl: 2, es: "Disculpe la demora.", en: "Sorry for the wait.", tip: "SO-rri for da wéit" },
    ...
    { id: "loc-gui04", cat: "guias", lvl: 2, es: "La ciudad fue fundada en 1533.", en: "The city was founded in 1533.", tip: "da SÍ-ti was FÁUN-ded in..." },
    { id: "loc-gui05", cat: "guias", lvl: 1, es: "Tenemos quince minutos para fotos.", en: "We have fifteen minutes for photos.", tip: "wi jav fif-TÍN MÍ-nits for FÓU-tos" },
    { id: "loc-gui06", cat: "guias", lvl: 2, es: "No se alejen del grupo.", en: "Please don't wander off from the group.", tip: "plis dont WÁN-der of from da grup" },
    { id: "loc-gui07", cat: "guias", lvl: 1, es: "Nos vemos en el bus a las tres.", en: "Let's meet at the bus at three.", tip: "lets mit at da bos at zri" },
