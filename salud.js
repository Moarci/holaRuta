...
(function () {
  ...
  const PHRASES = [
    ...
    },
    {
      ...
      items: [
        ...
        { es: "¿Tiene curitas / tiritas?", de: "Haben Sie Pflaster?", en: "Do you have plasters / band-aids?" },
  ...
  const GLOSSARY = [
    ...
    { es: "la curita / la tirita", de: "das Pflaster", en: "plaster / band-aid" },
    ...
    { es: "el snack / el bocadillo", de: "der Snack / die Kleinigkeit zu essen", en: "snack / bite to eat" },
  ];
